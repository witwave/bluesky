...
<head>
	...
	<!--[if lt IE 9]>
		...
		http://ecommerceforest.com/wrap/shoppe-stores-v2.4/demos/wedding-shoppe/category-grid.html
	<![endif]-->
			...
			<!-- Navbar Cat collapse Starts -->
				<div class="collapse navbar-collapse navbar-cat-collapse">
					<ul class="nav navbar-nav">
						<li><a href="category-list.html">Wedding Decoration</a></li>
						<li class="dropdown">
							...
							<ul class="dropdown-menu" role="menu">
								...
								<li><a tabindex="-1" href="#">Chains</a></li>
								<li><a tabindex="-1" href="#">Necklace</a></li>
							</ul>
						</li>
						<li class="dropdown">
							<a href="category-list.html" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="10">Wedding Flowers</a>
						...
						<li><a href="category-list.html">Bridal Dress</a></li>
						<li><a href="category-list.html">Bridal Suits</a></li>
						<li><a href="category-list.html">Wedding Rings</a></li>
						<li class="dropdown">
					<a href="category-list.html" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="10">
						Pages
					</a>
...
<!-- Footer Section Starts -->
	...
	<!-- Copyright Area Starts -->
		...
		<!-- Container Starts -->
			...
			<!-- Starts -->
				<p class="pull-left">
					&copy; 2014 Wedding Shoppe Stores. Designed By <a href="http://sainathchillapuram.com">Sainath Chillapuram</a>
				</p>
			<!-- Ends -->
